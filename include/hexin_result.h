 ...
 * Values: 0 - 999
 */
#define HEXIN_RESULT_LIST( prefix ) \
...
typedef enum
{
    HEXIN_RESULT_LIST     ( HEXIN_            )  /*     0 -   999 */
    //WWD_RESULT_LIST       ( HEXIN_WWD_        )  /*  1000 -  1999 */
    RESOURCE_RESULT_LIST  ( HEXIN_RESOURCE_   )  /*  4000 -  4999 */
    PLATFORM_RESULT_LIST  ( HEXIN_PLATFORM_   )  /*  6000 -  6999 */
    FILESYSTEM_RESULT_LIST( HEXIN_FILESYSTEM_ )  /* 10000 - 10999 */
} hexin_result_t;
