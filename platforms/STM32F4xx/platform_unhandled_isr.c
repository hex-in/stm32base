...
// PLATFORM_SET_DEFAULT_ISR( SVC_irq                , UnhandledInterrupt )
PLATFORM_SET_DEFAULT_ISR( DebugMonitor           , UnhandledInterrupt )
// PLATFORM_SET_DEFAULT_ISR( PENDSV_irq             , UnhandledInterrupt )
// PLATFORM_SET_DEFAULT_ISR( SYSTICK_irq            , UnhandledInterrupt )
